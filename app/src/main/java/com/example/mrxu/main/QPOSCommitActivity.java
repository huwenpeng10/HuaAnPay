...
public class QPOSCommitActivity extends BaseActivity {
    ...
    public int bindLayout() {
        ...
        return R.layout.activity_qposcommit;
    }
    ...
    private void commitCardData(int tapyNum) {
...
//                      IC卡
                        ...
                        new TcpRequest(Construction.HOST,
                                ...
                                .request(new QPOSBlueToothAccountReplenishing_ck(
                                        this, Double.parseDouble(TradeInfo.getInputMoney()),
                                        TradeInfo.getDeviceSn(),
                                        trackCount, expiryDate, icSerialNum, data55)
                                        .toString());
...
//                      IC卡
                        ...
                        new TcpRequest(Construction.HOST,
                                ...
                                .request(new PhoneReplenish_ck(
                                        this, Double.parseDouble(TradeInfo.getInputMoney()),
                                        TradeInfo.getDeviceSn(),
                                        trackCount,TradeInfo.getReplenishingCode(),TradeInfo.getReplenishingPhoneNumber(), expiryDate, icSerialNum, data55)
                                        .toString());
...
//                      磁条卡
                        ...
                        new TcpRequest(Construction.HOST,
                                ...
                                .request(new PhoneReplenish(
                                        this, Double.parseDouble(TradeInfo.getInputMoney()),
                                        TradeInfo.getDeviceSn(),
                                        trackCount,TradeInfo.getReplenishingCode(),TradeInfo.getReplenishingPhoneNumber())
                                        .toString());
    ...
    public void onEvent(TcpRequestMessage message) {
        ...
        if (message.getCode() == 1) {
            ...
            if (message.getCode() == -2) {
                runOnUiThread(new Runnable() {
                    public void run() {
                        MainUtils.showToast(QPOSCommitActivity.this,
                                "网络连接超时...");
                    }
                });
            }
    ...
    private void runFunction(final TradeInfo.PageState function,
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                switch (function) {
                    case SHUAKAZHIFU:
                        successIntent.setClass(QPOSCommitActivity.this,
                        ...
                        successIntent
                                .putExtra(
                                        ...
                                        TagUtils.Field011(QPOSCommitActivity.this));
                    ...
                    case SHOUJICHONGZHI:
                        final OkAppDialog okAppDialog =new OkAppDialog(QPOSCommitActivity.this);
    ...
    private void runError(final TradeInfo.PageState function,
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                switch (function) {
                    case SHUAKAZHIFU:
                        failureIntent.setClass(QPOSCommitActivity.this,
